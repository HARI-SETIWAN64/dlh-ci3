          ...
          <div class="row">
            <div class="app-dev">
              ...
              <div class="col-sm-6 col-md-6 col-lg-3 info">
                <div class="member">
                  <img src="<?php echo base_url()?>template/blue/images/01.jpg" alt="">
                  <div class="details">
              ...
              <div class="col-sm-6 col-md-6 col-lg-3 info">
                <div class="member">
                  <img src="<?php echo base_url()?>template/blue/images/02.jpg" alt="">
                  <div class="details">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo veniam molestias saepe ipsa autem, odio.</p>
                    <div class="social icon">
                      <ul>
              ...
              <div class="col-sm-6 col-md-6 col-lg-3 info">
                <div class="member">
                  <img src="<?php echo base_url()?>template/blue/images/03.jpg" alt="">
                  <div class="details">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo veniam molestias saepe ipsa autem, odio.</p>
                    <div class="social icon">
                      <ul>
              ...
              <div class="col-sm-6 col-md-6 col-lg-3 info">
                <div class="member">
                  <img src="<?php echo base_url()?>template/blue/images/04.jpg" alt="">
                  <div class="details">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo veniam molestias saepe ipsa autem, odio.</p>
                    <div class="social icon">
                      <ul>
