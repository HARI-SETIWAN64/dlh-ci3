...
<body>
                ...
                <div class="col-12 h-100">
                    <div class="menu_area h-100">
                        <nav class="navbar h-100 navbar-expand-lg align-items-center">
                            <!-- Logo -->
                            <a class="navbar-brand" href="index.html"><img src="<?php echo base_url()?>img/mosh/core-img/logo.png" alt="logo"></a>
        ...
        <div class="hero-slides owl-carousel">
            ...
            <div class="single-hero-slide d-flex align-items-end justify-content-center">
                <div class="hero-slide-content text-center">
                    ...
                    <img class="slide-img" src="<?php echo base_url()?>img/mosh/bg-img/device.png" alt="">
                </div>
            </div>
            <!-- Single Hero Slides -->
            <div class="single-hero-slide d-flex align-items-end justify-content-center">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="clients-logo-area d-sm-flex align-items-center justify-content-between">
                        <a href="#"><img src="<?php echo base_url()?>img/mosh/clients-img/1.png" alt=""></a>
                        <a href="#"><img src="<?php echo base_url()?>img/mosh/clients-img/2.png" alt=""></a>
                        <a href="#"><img src="<?php echo base_url()?>img/mosh/clients-img/3.png" alt=""></a>
                        <a href="#"><img src="<?php echo base_url()?>img/mosh/clients-img/4.png" alt=""></a>
                        <a href="#"><img src="<?php echo base_url()?>img/mosh/clients-img/5.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mosh-features-area section_padding_100 clearfix">
        ...
        <div class="features-img">
            <img src="<?php echo base_url()?>img/mosh/bg-img/features.png" alt="">
        </div>
    </section>
    <!-- ***** Feature Area End ***** -->
    ...
    <section class="mosh-more-services-area d-sm-flex clearfix">
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay=".1s">
                <img src="<?php echo base_url()?>img/mosh/core-img/trophy.png" alt="">
                <h4>No1 in Sales!</h4>
        ...
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay=".4s">
                <img src="<?php echo base_url()?>img/mosh/core-img/edit.png" alt="">
        ...
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay=".7s">
                <img src="<?php echo base_url()?>img/mosh/core-img/video-camera.png" alt="">
                <h4>Modern Design</h4>
        ...
        <div class="single-more-service-area">
            <div class="more-service-content text-center wow fadeInUp" data-wow-delay="1s">
                <img src="<?php echo base_url()?>img/mosh/core-img/presentation.png" alt="">
    ...
    <section class="mosh-portfolio-area section_padding_100_0 clearfix">
        ...
        <div class="mosh-portfolio">
            ...
            <div class="single_gallery_item gd">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/1.jpg" alt="">
            ...
            <div class="single_gallery_item bi">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/2.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item gd bi">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/3.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item pho">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/4.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <!-- Single gallery Item Start -->
            <div class="single_gallery_item pho">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/5.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item wd pc">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/6.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item wd">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/7.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
            ...
            <div class="single_gallery_item pc">
                <img src="<?php echo base_url()?>img/mosh/portfolio-img/8.jpg" alt="">
                <div class="gallery-hover-overlay d-flex align-items-center justify-content-center">
                    <div class="port-hover-text text-center">
                        <h4>DFR Corp. Branding</h4>
                        <a href="#">Brand Identity</a>
    ...
    <section class="mosh-workflow-area section_padding_100_0 clearfix">
        ...
        <div class="workflow-img">
            <img src="<?php echo base_url()?>img/mosh/core-img/work-progress.png" alt="">
        </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-100">
                            ...
                            <img src="<?php echo base_url()?>img/mosh/core-img/logo.png" alt="logo">
                            </a>
                        ...
                        <div class="single-footer-widget mb-100">
                            ...
                            <div class="footer-single-contact-info d-flex">
                                <div class="contact-icon">
                                    <img src="<?php echo base_url()?>img/mosh/core-img/map.png" alt="">
                                </div>
                                <p>4127/ 5B-C Mislane Road, Gibraltar, UK</p>
                            </div>
                            <div class="footer-single-contact-info d-flex">
                                <div class="contact-icon">
                                    <img src="<?php echo base_url()?>img/mosh/core-img/call.png" alt="">
                                </div>
                                <p>Main: 203-808-8613 <br> Office: 203-808-8648</p>
                            </div>
                            <div class="footer-single-contact-info d-flex">
                                <div class="contact-icon">
                                    <img src="<?php echo base_url()?>img/mosh/core-img/message.png" alt="">
                                </div>
