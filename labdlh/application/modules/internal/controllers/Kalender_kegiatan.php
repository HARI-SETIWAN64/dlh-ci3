...
class Kalender_kegiatan extends CI_Controller {
    ...
    public function index() {
		...
		$this->template->content->view('kalender_kegiatan/v_index',  isset($data) ? $data : NULL);
    ...
    public function data_calender() {
        ...
        $data=array();
        $this->load->view('internal/kalender_kegiatan/v_kalender', $data);
    }
	...
	{
        $json = array();
        $data = $this->kegiatan_model->get_objects_calender();
