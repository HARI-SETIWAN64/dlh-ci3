...
<script type="text/javascript">
	...
	function ubah(id)
	{
		...
		$.get(url+'internal/galery/ubah/'+id,{}, function(data) {
...
function delet(id){
	$.ajax({
		url: site+'internal/galery/hapus/'+id, 
		success: function(r){
			json = $.parseJSON(r);
...
function get_items(page){
	...
	var datae = {'page' : page};
	$.post(url+'internal/galery/data_list',$(document.filter.elements).serialize() + '&' + $.param(datae),
		function(data) {
