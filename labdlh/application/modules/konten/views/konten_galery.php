                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="blog-post-thumb" align="center">
                                ...
                                <div class="mosh-portfolio-area section_padding_100">
                                    <div class="mosh-portfolio">
                                        <?php foreach ($datas as $data) { ?>
                                            <div class="single_gallery_item gd">
                                                <img src="<?php echo base_url(); ?>/file/galery/<?php echo $data->file; ?>"
                                                    alt="">
                                                <div
                                                    class="gallery-hover-overlay d-flex align-items-center justify-content-center">
            ...
            <div class="col-md-3">
                <div class="mosh-blog-sidebar">
                    ...
                    <div class=" latest-blog-posts mb-100">
                        <font size="5px" style="font-family: " calibri", Garamond, 'Comic Sans MS' ;">Post
                            Terakhir</font>
                        <hr style="height:3px;border:none;color:#333;background-color:#333; margin-top: 0px">
                        </hr>
