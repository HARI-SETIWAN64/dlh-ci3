                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="blog-post-thumb">
                                                <img src="<?php echo base_url() ?>images/konten/<?php echo $kontens->images; ?>"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <!-- Post Meta -->
                                            <div class="post-meta">
                                                <a href="<?php echo base_url() . 'konten/konten_detail/' . $kontens->alias ?>">
                                                    <font size="4" color="#000"><b>
                                                            <?php echo $kontens->title; ?>
                                                        </b></font>
                                                </a>
                                                <h6>By <a href="#">Admin,</a><a href="#">
                                                        <?php echo $kontens->created; ?>,
                                                    </a><a href="#">
                                                        <?php echo $kategori[$kontens->catid]; ?>
                                                    </a></h6>
                                            </div>
                                            <!-- Post Title -->
                                            <!-- Post Excerpt -->
                                            <p>
                                                <?php echo substr($kontens->introtext, 0, 200); ?><a
                                                    href="<?php echo base_url() . 'konten/konten_detail/' . $kontens->alias ?>">
                                                    Baca Selengkapnya</a>
                                            </p>
                                        </div>
                                    </div>
