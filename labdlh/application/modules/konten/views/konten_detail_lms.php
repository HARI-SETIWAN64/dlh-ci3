                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="blog-post-thumb" align="center">
                                <?php if ($news->images <> "") { ?>
                                    <img src="<?php echo base_url() ?>images/konten/<?php echo $news->images; ?>" alt=""
                                        style="max-height: 500px; max-width: 70%" data-action="zoom">
                                <?php } ?>
                            </div>
                            </br></br>
                            ...
                            <div class="isi">
                                ...
                                <?php if ($news->pdf <> "") { ?>
                                    <embed align="center" src="<?php echo base_url() ?>pdf/<?php echo $news->pdf; ?>"
                                        width="100%" height="700px" type='application/pdf'></embed>
                                <?php } ?>
                            </div>
                            ...
                            <div class="youtobe">
                                ...
                                src="https://www.youtube.com/embed/<?= $news->youtube_id ?>"></iframe>
                                <?php } ?>
                            </div>
                            ...
                            <div class="single-latest-blog-post d-flex">
                                <div class="latest-blog-post-thumb">
                                    <?php if ($lms_kontens->images <> '') { ?>
                                        <img src="<?php echo base_url() ?>images/konten/<?php echo $lms_kontens->images; ?>"
                                            alt="">
                                    <?php } else { ?>
                                ...
                                <div class="latest-blog-post-content">
                                    <a href="<?php echo base_url() . 'konten/konten_detail_lms/' . $lms_kontens->alias ?>">
                                        <font size="2" color="#000"><b>
                                                <?php echo $lms_kontens->title; ?>
                                            </b></font>
                                    </a>
                                    <div class="post-meta">
                                        <h6>By <a href="#">Admin,</a><a href="#">
                                                <?php echo $lms_kontens->created; ?>,
                                            </a><a href="#">
                                                <?php echo $kategori[$lms_kontens->catid]; ?>
                                            </a></h6>
                                    </div>
                                </div>
                            </div>
