...
<table class="table table-bordered table-striped">
 ...
 <?php foreach($items as $row) :?>
    <tr>
      ...
      <td>
        <a href="javascript:void(0)" onclick="ubah('<?php echo $row->id_alat?>')" class="btn btn-xs btn-warning"> <i class="fa fa-pencil"></i> Ubah</a>
        <a href="javascript:void(0)" onclick="hapus('<?php echo $row->id_alat?>')" class="btn btn-xs btn-danger"> <i class="fa fa-trash-o"></i> Hapus</a>
      </td> 
    </tr>
 <?php endforeach; ?>
</table>
