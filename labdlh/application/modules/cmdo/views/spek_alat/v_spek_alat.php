<div class="box box-default">
	<div class="box-header with-border">
    	...
    	<div style="float: right;">
			<a href="cmdo/spek_alat/form/" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> &nbsp;Tambah</a>
		</div>
	</div>
	<div class="box-body">
		<div class="row">
...
function ubah(id)
{
    ...
    $('.modal-title').text('Merubah Spesifikasi Alat');
    $.get(url+'cmdo/spek_alat/ubah/'+id,{}, function(data) {
...
function delet(id){
  	$.ajax({
        url: site+'cmdo/spek_alat/hapus/'+id, 
        success: function(r){
	      	json = $.parseJSON(r);
...
function get_items(page){
	...
	var datae = {'page' : page};
	$.post(url+'cmdo/spek_alat/spek_alat_list',$(document.filter.elements).serialize() + '&' + $.param(datae),
	function(data) {
