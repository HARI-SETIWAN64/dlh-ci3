...
function ubah(id)
{
    ...
    $.get(url+'ujibanding/jenis_sampel/ubah/'+id,{}, function(data) {
        $("#ajax-modalin").html(data);
    });
}

function tampil(id,tampil){
  	$.ajax({
        url: url+'ujibanding/jenis_sampel/tampil/'+id+'/'+tampil, 
        success: function(r){
	      	json = $.parseJSON(r);
...
function get_items(page){
	...
	var datae = {'page' : page};
	$.post(url+'ujibanding/jenis_sampel/jenis_sampel_list',$(document.filter.elements).serialize() + '&' + $.param(datae),
	function(data) {
