	...
	<div class="box-header with-border">
		...
		<?php if ($this->ion_auth->in_group(array('analis', 'admin'))) { ?>
			<div style="float: right;">
				<a href="lms/pengujian/tambah" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> &nbsp;Tambah</a>
			</div>
		<?php } ?>
	</div>
	<div class="box-body">
...
<script type="text/javascript">
	...
	function ubah(id) {
		...
		$.get(url + 'lms/pengujian/ubah/' + id, {}, function (data) {
	...
	function delet(id) {
		$.ajax({
			url: site + 'lms/pengujian/hapus/' + id,
			success: function (r) {
				json = $.parseJSON(r);
	...
	function get_items(page) {
		...
		var datae = { 'page': page };
		$.post(url + 'lms/pengujian/data_list', $(document.filter.elements).serialize() + '&' + $.param(datae),
			function (data) {
