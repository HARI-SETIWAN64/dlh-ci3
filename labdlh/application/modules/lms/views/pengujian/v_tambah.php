    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel-body">
          <?php echo form_open_multipart('lms/pengujian/tambah', 'class="form-horizontal"'); ?>
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10" readonly>
                <?php echo form_input('jenis_dokumen', isset($item->jenis_dokumen) ? $item->jenis_dokumen : 'Pengujian', 'class="form-control" id="jenis_dokumen" readonly'); ?>
              </div>
            </div>
            <div class="form-group">
              <label for="" class="col-md-2 control-label">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <?php echo form_dropdown('sampel_id', $jenis_sampel, isset($item->sampel_id) ? $item->sampel_id : '', 'class="form-control"  id="sampel_id"'); ?>
                <?php echo form_error('sampel_id') ; ?>
              </div>
            </div>
