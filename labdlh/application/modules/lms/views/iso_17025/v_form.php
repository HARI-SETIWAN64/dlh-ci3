    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel-body">
          ...
          <?php echo form_open_multipart('lms/iso_17025/simpan_form' . $get, 'class="form-horizontal"'); ?>
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10" readonly>
                <?php echo form_input('jenis_dokumen', isset($item->jenis_dokumen) ? $item->jenis_dokumen : 'Iso-17025', 'class="form-control" id="jenis_dokumen" readonly'); ?>
              </div>
            </div>
            <div class="form-group">
              <label for="" class="col-md-2 control-label">
