	...
	<div class="box-header with-border">
		...
		<?php if ($this->ion_auth->in_group(array('analis','admin'))) { ?>
			<div style="float: right;">
				<a href="lms/lain_lain/tambah" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>
					&nbsp;Tambah</a>
			</div>
		<?php } ?>
	</div>
...
<script type="text/javascript">
	...
	function ubah(id) {
		...
		$.get(url + 'lms/lain_lain/ubah/' + id, {}, function (data) {
	...
	function delet(id) {
		$.ajax({
			url: site + 'lms/lain_lain/hapus/' + id,
			success: function (r) {
				json = $.parseJSON(r);
	...
	function get_items(page) {
		...
		var datae = { 'page': page };
		$.post(url + 'lms/lain_lain/data_list', $(document.filter.elements).serialize() + '&' + $.param(datae),
			function (data) {
