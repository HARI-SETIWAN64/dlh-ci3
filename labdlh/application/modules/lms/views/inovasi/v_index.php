	...
	<div class="box-header with-border">
		...
		<?php if ($this->ion_auth->in_group(array('analis', 'admin'))) { ?>
			<div style="float: right;">
				<a href="lms/inovasi/tambah" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> &nbsp;Tambah</a>
			</div>
		<?php } ?>
	</div>
	<div class="box-body">
...
<script type="text/javascript">
	...
	function ubah(id) {
		...
		$.get(url + 'lms/inovasi/ubah/' + id, {}, function (data) {
	...
	function get_items(page) {
		...
		var datae = { 'page': page };
		$.post(url + 'lms/inovasi/data_list', $(document.filter.elements).serialize() + '&' + $.param(datae),
			function (data) {
