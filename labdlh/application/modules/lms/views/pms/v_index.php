	...
	<div class="box-header with-border">
		...
		<?php if ($this->ion_auth->in_group(array('analis', 'admin'))) { ?>
			<div style="float: right;">
				<a href="lms/pms/tambah" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>
					&nbsp;Tambah</a>
			</div>
		<?php } ?>
	</div>
...
<script type="text/javascript">
	...
	function ubah(id) {
		...
		$.get(url + 'lms/pms/ubah/' + id, {}, function (data) {
	...
	function get_items(page) {
		...
		var datae = { 'page': page };
		$.post(url + 'lms/pms/data_list', $(document.filter.elements).serialize() + '&' + $.param(datae),
			function (data) {
