...
class Pms extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model(array('lms/pms_model'));
	...
	public function index()
	{
		...
		$this->template->title = 'Pms';
		$data['menu'] = 'pms';
		$this->template->description = '';
		$this->template->meta->add('keyword', '');
		$this->template->content->view('pms/v_index', isset($data) ? $data : NULL);
	...
	public function data_list()
	{
		...
		$data['items'] = $this->pms_model->get_list($where, $limit, $offset, $like)->result();
		$tot = $this->pms_model->get_list_total($where, $like)->row();
		$data['total_items'] = $tot->count;
		$data['page'] = $pagenya;
		$this->load->view('pms/v_list', $data);
	}

	public function tambah() {
		if (!$this->ion_auth->logged_in())
		{
			redirect('auth/login?continue='.urlencode(base_url().'lms/pms'));
		}
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->template->title = 'Form PMS';
			$data['menu'] = 'pms';
			$this->template->description = '';
			$this->template->meta->add('keyword', '');
			$this->template->content->view('pms/v_tambah', $data);
			$this->template->publish();
		}else{
			if ($_FILES["file"]["name"] <> "") {
	...
	public function form($id = "")
	{
		...
		$this->template->title = 'Form Hasil pms';
		$data['menu'] = 'pms';
		$data['id'] = $id;
		$this->template->description = '';
		$this->template->meta->add('keyword', '');
		$this->template->content->view('pms/v_form', $data);
		$this->template->publish();
	}
