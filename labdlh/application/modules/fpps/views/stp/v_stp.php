<div class="box box-default">
	<div class="box-header with-border">
    	...
    	<div class="pull-right">
			<a href="fpps/stp/" class="btn btn-success btn-sm disabled"><i class="fa fa-check-circle-o"></i> &nbsp;Valid</a> &nbsp;
			<a href="fpps/stp/stp_invalid/" class="btn btn-danger btn-sm"><i class="fa fa-times-circle-o"></i> &nbsp;Invalid</a>&nbsp;
		</div>
	</div>
	<div class="box-body">
		<div class="row">
...
function ubah_footer(id)
{
    ...
    $.get(url+'fpps/stp/ubah_footer/'+id,{}, function(data) {
