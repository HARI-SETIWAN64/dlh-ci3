          ...
          <div class="panel-body">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 bootstrap-timepicker"><?php echo form_input('jam_penerimaan',  isset($item->jam_penerimaan) ? $item->jam_penerimaan : '','class="form-control timepicker" id="jam_penerimaan"');?><?php echo form_error('jam_penerimaan') ; ?>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="panel-body">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8 bootstrap-timepicker"><?php echo form_input('serahkan_jam', isset($item->serahkan_jam) ? $item->serahkan_jam : '','class="form-control timepicker" id="serahkan_jam"');?><?php echo form_error('serahkan_jam') ; ?></div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
...
<script type="text/javascript">
  ...
  function delet(id){
    $.ajax({
        url: site+'fpps/stp/hapus_parameter/'+id, 
        success: function(r){
          json = $.parseJSON(r);
  ...
  function tambah(id)
  {
    $('#ajax-modal').modal('show');
      ...
      $.get(url+'fpps/stp/form_parameter/'+id,{}, function(data) {
          $("#ajax-modalin").html(data);
      });
  }

  function ubah_analis(id)
  {
    $('#ajax-modal').modal('show');
      $('.modal-title').text('Tambah Parameter');
      $.get(url+'fpps/stp/form_analis/'+id,{}, function(data) {
          $("#ajax-modalin").html(data);
      });
  }
  ...
  function get_items(page){
    ...
    var datae = {'page' : page};
    $.post(url+'fpps/stp/stp_ubah_parameter_list', $.param(like) + '&' + $.param(datae),
    function(data) {
