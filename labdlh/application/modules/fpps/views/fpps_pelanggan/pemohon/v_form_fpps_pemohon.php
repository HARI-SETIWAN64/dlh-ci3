<section>
	...
	echo form_open_multipart('fpps/fpps_pemohon/form'.$nomor, 'class="form-horizontal"');
	// print_r(date(now));
	?>
					...
					<div class="panel-body">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-8"><?php echo form_input('nama_pelanggan', isset($item->nama_pelanggan) ? $item->nama_pelanggan : $perusahaan->nama,'class="form-control" id="nama_pelanggan" readonly');?><?php echo form_error('nama_pelanggan') ; ?></div>
							</div>
							<div class="form-group">
								<label for="no_telp" class="col-md-4 control-label">Telp * :</label>
								<div class="col-md-8"><?php echo form_input('no_telp', isset($item->no_telp) ? $item->no_telp : $perusahaan->telp,'class="form-control"  id="no_telp" readonly');?><?php echo form_error('no_telp') ; ?></div>
							</div>
							<div class="form-group">
								<label for="email" class="col-md-4 control-label">Email * :</label>
								<div class="col-md-8"><?php echo form_input('email', isset($item->email) ? $item->email : $perusahaan->email,'class="form-control" id="email" readonly');?><?php echo form_error('email') ; ?></div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="jenis_industri" class="col-md-4 control-label">Jns Usaha * :</label>
								<div class="col-md-8"><?php echo form_input('jenis_industri', isset($item->jenis_industri) ? $item->jenis_industri : $perusahaan->jenis_usaha,'class="form-control" id="jenis_industri" readonly');?><?php echo form_error('jenis_industri') ; ?></div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									$data = array(
										'name'        => 'alamat',
										'id'          => 'alamat',
										'value'       => isset($item->alamat) ? $item->alamat : $perusahaan->alamat,
										'rows'        => '3',
										'cols'        => '5',
										'style'       => 'width:100%',
										'class'       => 'form-control',
					...
					<div class="panel-body">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-4 bootstrap-timepicker"><?php echo form_input('jam_penerimaan', isset($item->jam_sampling) ? $item->jam_penerimaan : '','class="form-control timepicker" id="jam_penerimaan"');?><?php echo form_error('jam_penerimaan') ; ?>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4 bootstrap-timepicker"><?php echo form_input('jam_sampling', isset($item->jam_sampling) ? $item->jam_sampling : '','class="form-control timepicker" id="jam_sampling"');?><?php echo form_error('jam_sampling') ; ?>
								</div>
							</div>
							<div class="form-group">
	...
	<div class="form-group">
		...
		<?php echo form_hidden('id_pelanggan', isset($item->id_palanggan) ? $item->id_palanggan : $perusahaan->id); ?>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$('#nama_pelanggan').autocomplete({
			source: "<?php echo site_url('fpps/fpps_pemohon/get_autocomplete');?>",
