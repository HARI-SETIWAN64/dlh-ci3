          ...
          <div class="panel-body">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-md-10"><?php echo form_dropdown('id_pelanggan', $nama_pelanggan, isset($item->id_pelanggan) ? $item->id_pelanggan : '','class="form-control select2" id="id_pelanggan" onchange="get_data()"');?><?php echo form_error('id_pelanggan') ; ?>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8"><?php echo form_input('jenis_industri', isset($item->jenis_industri) ? $item->jenis_industri : '','class="form-control" id="jenis_industri"');?><?php echo form_error('jenis_industri') ; ?></div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="panel-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-md-8">
                <?php echo form_dropdown('jenis_sampel', $jenis_sampel, isset($item->jenis_sampel) ? $item->jenis_sampel : '','class="form-control" id="jenis_sampel" required');?><?php echo form_error('jenis_sampel') ; ?>
              </div>
            </div>
            <div class="form-group">
              <label for="jumlah_sampel" class="col-md-4 control-label">Jumlah Sampel * :</label>
              <div class="col-md-8">
                <?php echo form_input('jumlah_sampel', isset($item->jumlah_sampel) ? $item->jumlah_sampel : '','class="form-control" id="jumlah_sampel"');?><?php echo form_error('jumlah_sampel') ; ?>
              </div>
            </div>
            <div class="form-group">
              <label for="volume_sampel" class="col-md-4 control-label">volume_sampel * :</label>
              <div class="col-md-8">
                <?php echo form_input('volume_sampel', isset($item->volume_sampel) ? $item->volume_sampel : '','class="form-control" id="volume_sampel"');?><?php echo form_error('volume_sampel') ; ?>
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-md-8">
                <?php echo form_input('wadah_sampel', isset($item->wadah_sampel) ? $item->wadah_sampel : '','class="form-control" id="wadah_sampel"');?><?php echo form_error('wadah_sampel') ; ?>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="pengukuran_lapangan" class="col-md-4 control-label">Pngkuran Lpngan * :</label>
              <div class="col-md-8">
                <?php
                $data = array(
        ...
        <div class="panel-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-md-6">
                <?php echo form_dropdown('kemampuan_personil', $kemampuan_personil, isset($item->kemampuan_personil) ? $item->kemampuan_personil : '','class="form-control" id="kemampuan_personil"');?><?php echo form_error('kemampuan_personil') ; ?>
              </div>
            </div>
            <div class="form-group">
              <label for="kesesuaian_metode_uji" class="col-md-6 control-label">Kesesuaian metode uji :</label>
              <div class="col-md-6">
                <?php echo form_dropdown('kesesuaian_metode_uji', $kesesuaian_metode_uji, isset($item->kesesuaian_metode_uji) ? $item->kesesuaian_metode_uji : '','class="form-control" id="kesesuaian_metode_uji"');?><?php echo form_error('kesesuaian_metode_uji') ; ?>
              </div>
            </div>
            <div class="form-group">
              <label for="tanggal_diambil" class="col-md-6 control-label">kondisi peralatan pengujian :</label>
              <div class="col-md-6">
                <?php echo form_dropdown('kondisi_peralatan', $kondisi_peralatan, isset($item->kondisi_peralatan) ? $item->kondisi_peralatan : '','class="form-control" id="kondisi_peralatan"');?><?php echo form_error('kondisi_peralatan') ; ?>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-md-6">
                <?php echo form_dropdown('kelengkapan_bahan_kimia', $kelengkapan_bahan_kimia, isset($item->kelengkapan_bahan_kimia) ? $item->kelengkapan_bahan_kimia : '','class="form-control" id="kelengkapan_bahan_kimia"');?><?php echo form_error('kelengkapan_bahan_kimia') ; ?>
              </div>
            </div>
            <div class="form-group">
              <label for="kondisi_akomodasi" class="col-md-6 control-label">Kondisi akomodasi :</label>
              <div class="col-md-6">
                <?php echo form_dropdown('kondisi_akomodasi', $kondisi_akomodasi, isset($item->kondisi_akomodasi) ? $item->kondisi_akomodasi : '','class="form-control" id="kondisi_akomodasi"');?><?php echo form_error('kondisi_akomodasi') ; ?>
              </div>
            </div>
            <div class="form-group">
              <label for="beban_pekerjaan" class="col-md-6 control-label">Beban pekerjaan :</label>
              <div class="col-md-6">
                <?php echo form_dropdown('beban_pekerjaan', $beban_pekerjaan, isset($item->beban_pekerjaan) ? $item->beban_pekerjaan : '','class="form-control" id="beban_pekerjaan"');?><?php echo form_error('beban_pekerjaan') ; ?>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="panel-body">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-md-8">
                <?php echo form_dropdown('kesimpulan_kaji_ulang', $kesimpulan_kaji_ulang,isset($item->kesimpulan_kaji_ulang) ? $item->kesimpulan_kaji_ulang : '','class="form-control"  id="kesimpulan_kaji_ulang"');?><?php echo form_error('kesimpulan_kaji_ulang') ; ?>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-md-8">
                <?php echo form_dropdown('subkontrak', $subkontrak,isset($item->subkontrak) ? $item->subkontrak : '','class="form-control"  id="subkontrak"');?><?php echo form_error('subkontrak') ; ?>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="panel-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <?php echo form_input('serahkan_perusahaan', isset($item->serahkan_perusahaan) ? $item->serahkan_perusahaan : '','class="form-control" id="serahkan_perusahaan"');?><?php echo form_error('serahkan_perusahaan') ; ?>
                </div>
              </div>
              <div class="form-group">
                <label for="serahkan_nama" class="col-md-4 control-label">Nama * :</label>
                <div class="col-md-8">
                  <?php echo form_input('serahkan_nama', isset($item->serahkan_nama) ? $item->serahkan_nama : '','class="form-control" id="serahkan_nama"');?><?php echo form_error('serahkan_nama') ; ?>
                </div>
              </div>
              <div class="form-group">
                <label for="serahkan_tanggal" class="col-md-4 control-label">Tanggal * :</label>
                <div class="col-md-8">
                  <?php echo form_input('serahkan_tanggal', isset($item->serahkan_tanggal) ? $item->serahkan_tanggal : '','class="form-control" id="serahkan_tanggal"');?><?php echo form_error('serahkan_tanggal') ; ?>
                </div>
              </div>
              <div class="form-group">
                <label for="serahkan_jam" class="col-md-4 control-label">Jam * :</label>
                <div class="col-md-8">
                  <?php echo form_input('serahkan_jam', isset($item->serahkan_jam) ? $item->serahkan_jam : '','class="form-control" id="serahkan_jam"');?><?php echo form_error('serahkan_jam') ; ?>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <?php echo form_input('terima_perusahaan',isset($item->terima_perusahaan) ? $item->terima_perusahaan : '','class="form-control"  id="terima_perusahaan"');?><?php echo form_error('terima_perusahaan') ; ?>
                </div>
              </div>
              <div class="form-group">
                <label for="terima_nama" class="col-md-4 control-label">Nama * :</label>
                <div class="col-md-8">
                  <?php echo form_input('terima_nama',isset($item->terima_nama) ? $item->terima_nama : '','class="form-control"  id="terima_nama"');?><?php echo form_error('terima_nama') ; ?>
                </div>
              </div>
              <div class="form-group">
                <label for="terima_tanggal" class="col-md-4 control-label">Tanggal * :</label>
                <div class="col-md-8">
                  <?php echo form_input('terima_tanggal',isset($item->terima_tanggal) ? $item->terima_tanggal : '','class="form-control"  id="terima_tanggal"');?><?php echo form_error('terima_tanggal') ; ?>
                </div>
              </div>
              <div class="form-group">
                <label for="terima_jam" class="col-md-4 control-label">Jam * :</label>
                <div class="col-md-8">
                  <?php echo form_input('terima_jam',isset($item->terima_jam) ? $item->terima_jam : '','class="form-control"  id="terima_jam"');?><?php echo form_error('terima_jam') ; ?>
                </div>
              </div>
            </div>
          </div>
...
<div class="form-group">
  <div align="center" id="simpan">
    ...
    <?php echo form_submit('submit', 'Simpan / Terverifikasi','class="btn btn-primary" onclick="return confirm(\'Apakah anda sudah yakin ?\');"');?>
  </div>
...
function delet(id){
  $.ajax({
    url: site+'fpps/fpps_pelanggan/hapus_parameter/'+id, 
    success: function(r){
      json = $.parseJSON(r);
...
function tambah(id)
{
  ...
  $.get(url+'fpps/fpps_pelanggan/form_parameter/'+id,{}, function(data) {
