    ...
    <div class="panel-body ">
        <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
              <?php echo form_input('hasil', isset($item->hasil) ? $item->hasil : '','class="form-control"  id="hasil"');?>
              </div>
            </div>
            <div class="form-group">
              <label for="" class="col-sm-4 control-label"> <div>Spesifikasi Metode</div> </label>
              <div class="col-sm-8">
              <?php echo form_input('spesifikasi_metode', isset($item->spesifikasi_metode) ? $item->spesifikasi_metode : '','class="form-control"  id="spesifikasi_metode"');?>
              </div>
            </div>
            <div class="form-group">
...
function simpan()
{
  $("#ajax_loader").show();
  $.ajax({
    url: '<?= base_url()?>lhu/lhu_admin/simpan_lhus_parameter/<?php echo $id?>', 
