    ...
    <div class="panel-body ">
        <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
              <?php echo form_input('satuan', isset($item->lhus_satuan) ? $item->lhus_satuan : $item->satuan,'class="form-control"  id="satuan"');?>
              </div>
            </div>
            <div class="form-group">
              <label for="" class="col-sm-4 control-label"> <div>Buku Mutu</div> </label>
              <div class="col-sm-8">
              <?php echo form_input('baku_mutu', isset($item->lhus_baku_mutu) ? $item->lhus_baku_mutu : $item->baku_mutu,'class="form-control"  id="baku_mutu"');?>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
              <?php echo form_input('spesifikasi_metode', isset($item->lhus_spesifikasi_metode) ? $item->lhus_spesifikasi_metode :  $item->metode,'class="form-control"  id="lhus_spesifikasi_metode"');?>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8"><?php echo form_dropdown('users_analis', $analis, isset($item->users_analis) ? $item->users_analis : '','class="form-control" id="users_analis"');?><?php echo form_error('users_analis') ; ?>
            </div>
            <div class="form-group">
...
function simpan()
{
  $("#ajax_loader").show();
  $.ajax({
    url: '<?= base_url()?>fpps/lhus/simpan_lhus_parameter/<?php echo $id?>', 
