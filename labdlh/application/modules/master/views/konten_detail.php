<?php
$kategori = array('1'=>'Berita','2'=>'Artikel','3'=>'Info','4'=>'Profil'); 
// print_r($news);
?>
                    ...
                    <div class="row">
                        <div class="col-12">
                        	<div class="blog-post-thumb" align="center">
                                <font size="4" color="#000"><b><?php echo $news->title; ?></b></font>
                            </br></br>
                            </div>
                            <div class="blog-post-thumb" align="center">
                            	<?php if($news->images <> ""){ ?>
                                	<img src="<?php echo base_url()?>images/konten/<?php echo $news->images;?>" alt="" style="max-height: 300px">
                            	<?php  } ?>
                            </div>
                        	</br></br>
                            <div class="post-meta" align="center">
                                <h6>By <a href="#">Admin,</a><a href="#"><?php echo $news->created;?>, </a><a href="#"><?php echo $kategori[$news->catid]; ?></a></h6>
                            </div>
                            <div class="isi">	
                            	<?php echo $news->introtext;?>
                            	<br>
                                <?php if($news->pdf<> ""){ ?>
                                    <embed align="center" src="<?php echo base_url()?>pdf/<?php echo $news->pdf; ?>" width="600 px" height="500" type='application/pdf'>
                                <?php } ?>
                            </div>
            ...
            <div class="col-md-3">
                <div class="mosh-blog-sidebar">
                    ...
                    <div class="blog-post-categories mb-100">
                        ...
                        <hr style="height:3px;border:none;color:#333;background-color:#333; margin-top: 0px"></hr>
                        <ul>
                            <li><a href="<?php echo base_url()?>">SEMUA</a></li>
