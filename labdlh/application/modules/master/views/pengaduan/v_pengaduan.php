...
function ubah(id)
{
    ...
    $.get(url+'master/pengaduan/ubah/'+id,{}, function(data) {
...
function delet(id){
  	$.ajax({
        url: site+'master/pengaduan/hapus/'+id, 
        success: function(r){
	      	json = $.parseJSON(r);
...
function get_items(page){
	...
	var datae = {'page' : page};
	$.post(url+'master/pengaduan/pengaduan_list',$(document.filter.elements).serialize() + '&' + $.param(datae),
	function(data) {
