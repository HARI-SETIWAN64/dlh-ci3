          ...
          <div class="panel-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <?php if(isset($item->tanggal_penerimaan)){ $pieces = explode(" ", $item->tanggal_penerimaan); $tanggal_penerimaan = $pieces[0]; $jam_penerimaan = $pieces[1]; } else {$tanggal_penerimaan = ''; $jam_penerimaan = '';} ?>
                <div class="col-md-3"><?php echo form_input('tanggal_penerimaan', $tanggal_penerimaan,'class="form-control" id="tanggal_penerimaan"');?><?php echo form_error('tanggal_penerimaan') ; ?>
                </div>
                <label class="col-md-1 control-label">Jam</label>
                <div class="col-md-4"><?php echo form_input('tanggal_penerimaan', $jam_penerimaan,'class="form-control" id="tanggal_penerimaan"');?><?php echo form_error('tanggal_penerimaan') ; ?>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <?php if(isset($item->tanggal_sampling)){ $pieces = explode(" ", $item->tanggal_sampling); $tanggal_sampling = $pieces[0]; $jam_sampling = $pieces[1]; } else {$tanggal_sampling = ''; $jam_sampling = '';} ?>
                <div class="col-md-3"><?php echo form_input('tanggal_sampling', $tanggal_sampling,'class="form-control" id="tanggal_sampling"');?><?php echo form_error('tanggal_sampling') ; ?>
                </div>
                <label class="col-md-1 control-label">Jam</label>
                <div class="col-md-4"><?php echo form_input('jam_sampling', $jam_sampling,'class="form-control" id="jam_sampling"');?><?php echo form_error('jam_sampling') ; ?>
                </div>
              </div>
              <div class="form-group">
...
<script type="text/javascript">
  ...
  $(function() {
      ...
      $('#tanggal_diambil').datepicker({
        format: "dd-mm-yyyy",
        autoclose: true,
        setDate: Date()
      });
      $("#tanggal_diambil").datepicker("setDate", currentDate);

      $('#serahkan_tanggal').datepicker({
        format: "dd-mm-yyyy",
        autoclose: true,
      });
      $("#serahkan_tanggal").datepicker("setDate", currentDate);

      $('#terima_tanggal').datepicker({
        format: "dd-mm-yyyy",
        autoclose: true,
      });
      $("#terima_tanggal").datepicker("setDate", currentDate);
  });
