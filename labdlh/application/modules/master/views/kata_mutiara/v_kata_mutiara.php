<div class="box box-default">
	<div class="box-header with-border">
    	...
    	<div style="float: right;">
			<a href="master/kata_mutiara/form/" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> &nbsp;Tambah</a>
		</div>
	</div>
	<div class="box-body">
		<div class="row">
...
function ubah(id)
{
    ...
    $.get(url+'master/kata_mutiara/ubah/'+id,{}, function(data) {
...
function delet(id){
  	$.ajax({
        url: site+'master/kata_mutiara/hapus/'+id, 
        success: function(r){
	      	json = $.parseJSON(r);
...
function get_items(page){
	...
	var datae = {'page' : page};
	$.post(url+'master/kata_mutiara/kata_mutiara_list',$(document.filter.elements).serialize() + '&' + $.param(datae),
	function(data) {
