<div class="box box-default">
	<div class="box-header with-border">
    	...
    	<div style="float: right;">
			<a href="master/jenis_sampel/form/" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> &nbsp;Tambah</a>
		</div>
	</div>
	<div class="box-body">
		<div class="row">
...
function ubah(id)
{
    ...
    $.get(url+'master/jenis_sampel/ubah/'+id,{}, function(data) {
...
function delet(id){
  	$.ajax({
        url: site+'master/jenis_sampel/hapus/'+id, 
        success: function(r){
	      	json = $.parseJSON(r);
...
function get_items(page){
	...
	var datae = {'page' : page};
	$.post(url+'master/jenis_sampel/jenis_sampel_list',$(document.filter.elements).serialize() + '&' + $.param(datae),
	function(data) {
