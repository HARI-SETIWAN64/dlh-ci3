	...
	function __construct($config = array())
{
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			<script type="text/javascript" src="' . ( ($this->https) ? 'https' : 'http' ) . '://oprdapodik.banyuwangikab.go.id/js/markerclusterer.js"></script>
			'; }
		}
		if ($this->jsfile=="") {
			$this->output_js .= '
		...
		if ($this->cluster) {
			$this->output_js_contents .= "
			var clusterStyles=[{anchor:[0,-2],iconAnchor:[0,0],textColor:'white',url:'../img/m1.png',height:53,width:52},{anchor:[0,-2],iconAnchor:[0,0],textColor:'white',url:'../img/m2.png',height:53,width:52},{anchor:[0,0],iconAnchor:[0,0],textColor:'white',url:'../img/m3.png',height:53,width:52},{anchor:[0,0],iconAnchor:[0,0],textColor:'white',url:'../img/m4.png',height:53,width:52},{anchor:[0,0],iconAnchor:[0,0],textColor:'white',url:'../img/m5.png',height:53,width:52}]";
			$this->output_js_contents .= '
			var clusterOptions = {
			...
			$this->output_js_contents .= ',
				...
				';
			$this->output_js_contents .="styles: clusterStyles";
			$this->output_js_contents .=',
			};
